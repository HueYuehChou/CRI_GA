...
*/
    ...
    Genes_Algorithm(wavelength_lower_limit,data_length,data_width,wavelength_interval,TCS_width,CIE1931,TCS,Daylight_SPD_1nm,Tc_lower,Tc_interval,Tc_point);
